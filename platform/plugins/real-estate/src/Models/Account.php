...
class Account extends Authenticatable
{
    ...
    protected $appends = ['property_count', 'Name'];

    protected $with = ['avatar:id,url'];
    ...
    public function propertiesApproved()
    {
        return $this->morphMany(Property::class, 'author')->where('moderation_status', 'approved');
    }
    ...
    {
        return $this->propertiesApproved()->count();
    }
