...
class Property extends BaseModel
{
    ...
    protected $with = [
        'author:id,first_name,last_name,avatar_id,company,phone,email',
        'author.avatar:id,url',
        'categories:id,name',
        'slugable',
        'metadata'
    ];
    ...
    {
        return count($this->images) > 0 ? \Storage::url(Arr::first($this->images)) : null;
    }

    public function metadata()
    {
        return $this->belongsTo(MetaBox::class, 'id', 'reference_id')->select('id', 'meta_value', 'meta_key', 'reference_id');
    }
