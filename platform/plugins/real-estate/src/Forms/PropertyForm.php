    ...
    public function buildForm()
    {
        ...
        $this
            ...
            ->add('square', 'number', [
                ...
                'attr'       => [
                    'placeholder' => 'Area in number',
                ],
            ])
            ->add('area_type', 'customSelect', [
                'label'      => 'Build-up Area Type',
                'label_attr' => ['class' => 'control-label required'],
                'wrapper' => [
                    'class' => 'form-group mb-1 col-md-4 '
                ],
            ...
            ->add('ropani', 'number', [
                ...
                'label_attr' => ['class' => 'control-label'],
                'wrapper'    => [
                    'class' => 'form-group mb-4 col-md-3',
                ],
                'attr'       => [
                    'placeholder' => 'Number of Ropani',
                ],
            ])
            ->add('aana', 'number', [
                'label'      => 'Aana',
            ...
            ->add('availability', 'customSelect', [
                ...
                'choices'    => [
                    ...
                    'After in 30 Days' => 'After 30 Days',
                ],

            ])
            ->add('furnishing', 'customSelect', [
                'label'      => 'Furnishing',
                'label_attr' => ['class' => 'control-label'],
                'wrapper' => [
                    'class' => 'form-group mb-3 col-md-4'
            ...
            ->add('period', 'customSelect', [
                ...
                'label_attr' => ['class' => 'control-label required'],
                'wrapper'    => [
                    'class' => 'form-group mb-3 period-form-group col-md-3' . ($this->getModel()->type != PropertyTypeEnum::RENT ? ' hidden' : null),
                ],
                'attr'       => [
                    'class' => 'form-control select-search-full',
                ],
